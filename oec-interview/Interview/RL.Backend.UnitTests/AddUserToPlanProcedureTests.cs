...
public class AddUserToPlanProcedureTests
{
    ...
    public async Task AddUserToPlanProcedureTests_InvalidPlanProcedureId_ReturnsBadRequest(int procedureId)
    {
        //Given
    ...
    public async Task AddUserToPlanProcedureTests_InvalidUserId_ReturnsBadRequest(int planProcedureId, int userId)
    {
        //Given
        var context = new Mock<RLContext>();
        var sut = new AddUserToPlanProcedureCommandHandler(context.Object);
    ...
    [DataRow(19, 19)]
    [DataRow(35, 35)]
    public async Task AddUserToPlanProcedureTests_PlanProcedureIdNotFound_ReturnsNotFound(int planProcedureId, int userId)
    {
        //Given
    ...
    [TestMethod]
    [DataRow(1, 1)]
    public async Task AddUserToPlanProcedureTests_AlreadyContainsUserPlanProcedure_ReturnsSuccess(int planProcedureId, int userId)
    {
        //Given
        var context = DbContextHelper.CreateContext();
        var sut = new AddUserToPlanProcedureCommandHandler(context);
